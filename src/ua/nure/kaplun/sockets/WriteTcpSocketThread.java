    ...
    public void run() {
        try {
           ...
           DataOutputStream dOut = new DataOutputStream(out);
            ...
            System.out.println(PrintColors.ANSI_YELLOW + "To change/choose other site companion enter " + SpecialCommands.SET_OTHER_SITE_CLIENT + "\n" +
            ...
            while (true) {
                ...
                switch (line) {
                    case SpecialCommands.SET_OTHER_SITE_CLIENT:
                        ...
                        Message message=new Message(SpecialCommands.SET_OTHER_SITE_CLIENT, client.getClientName(), inetAddress.getBytes());
